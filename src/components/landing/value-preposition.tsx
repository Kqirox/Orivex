  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-10">
        ...
        <button
          type="button"
          className="rounded-full bg-white px-6 py-3 text-sm font-bold text-[#0F172A] transition hover:bg-transparent sm:px-10  border border-transparent cursor-pointer hover:border-white"
        >
          Start Learning
        </button>
      </div>
